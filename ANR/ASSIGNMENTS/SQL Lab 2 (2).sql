...
56. Write a query to interchange the salaries of employee 120 and 122.
57. Write a query to increase the salary of employee 115 based on the following conditions: 
	If experience is more than 10 years - increase salary by 20%, 
	If experience is greater than 5 years - increase salary by 10%,
	Otherwise 5%.
58. Write a query to change commission percentage as follows for employee with ID = 150. 
	If salary is more than 10000 then commission is 0.4%, 
	if Salary is less than 10000 but experience is more than 10 years then 0.35%, 
	if salary is less than 3000 then commission is 0.25%, 
	In the remaining cases commission is 0.15%.
59. Write a query to find out the name of the employee and name of the department for the employee who is managing for employee 103.
60. Write a query to display the year in which maximum number of employees joined along with how many joined in each month in that year.
61. Write a query to change salary of employee 130 to the salary of the employee with first name ‘Joe’. If Joe is not found then take average salary of all employees.
62. Write a query to display 5th and 10th employees in Employees table.
